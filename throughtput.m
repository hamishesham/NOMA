...
for q =1:length(N)
for i = 1:iterate
    x_1(i,q) =through_average(N(q),5);
    x_2(i,q) =through_average(N(q),10);
    x_3(i,q) =through_average(N(q),15);
    x_4(i,q) =through_average(N(q),20);
    x_5(i,q) =through_average(N(q),25);
    x_6(i,q) =through_average(N(q),30);
    x_7(i,q) =through_average(N(q),40);
    x_8(i,q) =through_average(N(q),50);
    y_1(i,q) =through_proportional_fairness(N(q),5);
    y_2(i,q) =through_proportional_fairness(N(q),10);
    y_3(i,q) =through_proportional_fairness(N(q),15);
    y_4(i,q) =through_proportional_fairness(N(q),20);
    y_5(i,q) =through_proportional_fairness(N(q),25);
    y_6(i,q) =through_proportional_fairness(N(q),30);
    y_7(i,q) =through_proportional_fairness(N(q),40);
    y_8(i,q) =through_proportional_fairness(N(q),50);
